...
@section('page')
الفواتيرالتى تم تقديم طلب الغائها من {{ auth()->user()->details->company_name }}
@endsection
...
<table id="html5-extension" class="table table-hover non-hover" style="width:100%">
    <thead>
        <tr>
            ...
            <th>الإجمالى</th>
            <th>حالة الفاتورة</th>
            <th>تاريخ قبول الإلغاء</th>
            <th>توقيت قبول الإلغاء</th>
            <th>الرقم الداخلى </th>
            <th>عرض الفاتورة</th>
    ...
    <tbody>
        ...
        @if($invoice['issuerId'] == auth()->user()->details->company_id && $invoice['cancelRequestDate'] !== null && $invoice['status'] === "Valid")
        <tr>
