...
@section('page')
الفواتيرالتى تم ارسالها من {{ auth()->user()->details->company_name }} الى الشركات
@endsection
...
<table id="html5-extension" class="table table-hover non-hover" style="width:100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>تم تقديمها و جارى المراجعة</td>
            @elseif($invoice['status'] === "Rejected")
            <td>تم رفضها من الشركة</td>
            @else
            ...
            <td>
                <form action="{{ route('cancelDocument',$invoice['uuid']) }}" method="post">
                    @csrf
                    @method('PUT')
                    <button class="btn btn-danger" type="submit" onclick="return confirm('هل انت متأكد من  الغاء الفاتورة؟');">إلغاء الفاتورة</button>
                </form>
            </td>
        </tr>
        @endif
